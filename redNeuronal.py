...
Ascensor(0 (No) ,1 (Si)),
Exterior (0 (No) ,1 (Si))
Estado (0 (No rehabilitado) ,1 (rehabilitado), 2(nuevo)), 
Centrico(0 (No) -1 (Si))
"""


columns=[("Ciudad","M2","Nhabitaciones","Nplanta","Ascensor","ViviendaExterior","Estado","ViviendaCentrica")]
...
historial= modelo.fit(features,targets,epochs=1000,verbose=False) #verbose para que no se imprima nada en consola
